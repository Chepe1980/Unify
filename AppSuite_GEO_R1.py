...
with st.sidebar:
    ...
    app_mode = st.selectbox(
        "Select Module",
        ["Home", "AVAzMOD", "GeoStressMOD", "PasseyTOCMOD", "Machine Learning", "AVO Rock Physics"],
...
if app_mode == "Home":
    ...
    modules = [
        ...
        },
        {
            ...
            "icon": "🤖",
            "description": "Advanced AVO analysis and Rock Physics with Fluid Substitution (Gassmann Equation)",
            "color": "#9b59b6"
        }
    ]
