...
# Configure the app
st.set_page_config(
    page_title="Sonic Log Prediction with Neural Network",
    page_icon="⛏️",
    layout="wide",
...
def main():
    st.title("⛏️ Sonic Log Prediction using Neural Network")
    st.markdown("""
    This app predicts sonic travel time (DT) from other well log measurements using a Neural Network.
...
def process_and_train(las, input_curves, target_curve, epochs, batch_size, learning_rate, test_size, validation_split):
    ...
    with st.spinner("🔄 Processing data and training model..."):
        try:
            ...
            # Build model (using Dense layers instead of CNN)
            model = Sequential([
